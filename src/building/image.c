...
static const struct {
    ...
    int num_types;
        ...
        {TEXTURE_HOUSING_TENT,     0, 2},
        {TEXTURE_HOUSING_TENT,     2, 2},
        {TEXTURE_HOUSING_SHACK,    0, 2},
        {TEXTURE_HOUSING_SHACK,    2, 2},
        {TEXTURE_HOUSING_HOVEL,    0, 2},
        {TEXTURE_HOUSING_HOVEL,    2, 2},
        {TEXTURE_HOUSING_CASA,     0, 2},
        {TEXTURE_HOUSING_CASA,     2, 2},
        {TEXTURE_HOUSING_INSULA_1, 0, 2},
        {TEXTURE_HOUSING_INSULA_1, 2, 2},
        {TEXTURE_HOUSING_INSULA_2, 0, 2},
        {TEXTURE_HOUSING_INSULA_2, 2, 2},
        {TEXTURE_HOUSING_VILLA_1,  0, 2},
        {TEXTURE_HOUSING_VILLA_1,  2, 2},
        {TEXTURE_HOUSING_VILLA_2,  0, 1},
        {TEXTURE_HOUSING_VILLA_2,  1, 1},
        {TEXTURE_HOUSING_PALACE_1, 0, 1},
        {TEXTURE_HOUSING_PALACE_1, 1, 1},
        {TEXTURE_HOUSING_PALACE_2, 0, 1},
        {TEXTURE_HOUSING_PALACE_2, 1, 1},
};
...
int building_image_get(const building *b) {
    switch (b->type) {
        ...
        case BUILDING_THEATER:
            // TODO: Upgrade level?  b->upgrade_level
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_THEATER);
        ...
        case BUILDING_ACTOR_COLONY:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_ACTOR_COLONY);
        ...
        case BUILDING_PREFECTURE:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_PREFECTURE);
        ...
        case BUILDING_GRANARY:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_GRANARY);
        case BUILDING_MARKET:
            // TODO: Consider adding upgrade levels
            if (!b->upgrade_level) {
        ...
        case BUILDING_ENGINEERS_POST:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_ENGINEERS_POST);
        case BUILDING_FORUM:
            return image_group(GROUP_BUILDING_FORUM);
        case BUILDING_FOUNTAIN:
            // TODO: Consider adding upgrade levels for fountains?
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_FOUNTAIN);
        case BUILDING_WELL:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_WELL);
        case BUILDING_RESERVOIR:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_RESERVOIR);
        case BUILDING_MILITARY_ACADEMY:
            return image_group(GROUP_BUILDING_MILITARY_ACADEMY);
        case BUILDING_SMALL_TEMPLE_CERES:
            return assets_get_image_id(TEXTURE_RELEGION_NAME, TEXTURE_RELEGION_TEMPLE_CERES);
        case BUILDING_SMALL_TEMPLE_NEPTUNE:
            return assets_get_image_id(TEXTURE_RELEGION_NAME, TEXTURE_RELEGION_TEMPLE_NEPTUNE);
        case BUILDING_SMALL_TEMPLE_MERCURY:
            return assets_get_image_id(TEXTURE_RELEGION_NAME, TEXTURE_RELEGION_TEMPLE_MERCURY);
        case BUILDING_SMALL_TEMPLE_MARS:
            return assets_get_image_id(TEXTURE_RELEGION_NAME, TEXTURE_RELEGION_TEMPLE_MARS);
        case BUILDING_SMALL_TEMPLE_VENUS:
            return assets_get_image_id(TEXTURE_RELEGION_NAME, TEXTURE_RELEGION_TEMPLE_VENUS);
        ...
        case BUILDING_DECORATIVE_COLUMN:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_ROADBLOCK);
        ...
        case BUILDING_TOWER:
            return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_TOWER);
        case BUILDING_GATEHOUSE: {
            ...
            if (b->subtype.orientation == 1) {
                if (orientation_is_top_bottom) {
                    return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_TOWER) + 1;
                } else {
                    return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_TOWER) + 2;
                }
            } else {
                if (orientation_is_top_bottom) {
                    return assets_get_image_id(TEXTURE_BUILDING_NAME, TEXTURE_BUILDING_TOWER) + 2;
        ...
        case BUILDING_GARDEN_WALL_GATE:
            return assets_get_image_id("Aesthetics", "Garden Gate") +
