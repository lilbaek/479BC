...
int map_property_is_plaza(int grid_offset)
{
    return bitfields_grid.items[grid_offset] & BIT_PLAZA;
}

void map_property_mark_plaza(int grid_offset)
{
    bitfields_grid.items[grid_offset] |= BIT_PLAZA;
}

void map_property_clear_plaza(int grid_offset)
{
