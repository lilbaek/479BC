...
{
    platform_screen_show_error_message_box("479BC has crashed :(",
        "There was an unrecoverable error in 479BC, which will now close.\n\n"
#ifdef HAS_STACK_TRACE
        "The piece of code that caused the crash has been saved to 479BC-log.txt.\n\n"
#endif
        "If you can, please create an issue by going to:\n\n"
        "https://github.com/Keriew/479BC/issues/new \n\n"
        "Please attach "
#ifdef HAS_STACK_TRACE
        "479BC-log.txt and "
#endif
