...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_TITLE, "479BC configuration options"},
    ...
    {TR_HOTKEY_TITLE, "479BC hotkey configuration"},
    ...
    {TR_NO_EXTRA_ASSETS_MESSAGE,
        "The extra 479BC assets could not be loaded.\n"
    ...
    {TR_SAVEGAME_LARGER_VERSION_MESSAGE, "The savegame you're trying to load is for a more recent version of 479BC.\nPlease update 479BC to the most recent version." },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_TITLE, "Unable to save the game" },
    {TR_SAVEGAME_NOT_ABLE_TO_SAVE_MESSAGE, "It was not possible to save the game.\nIt may be because the folder where Caesar 3 keeps the savegames requires administrator access.\nPlease either change the Caesar 3 folder to a place which doesn't require administrator access or run 479BC as administrator (not recommended)." },
    ...
    {TR_EDITOR_UNABLE_TO_LOAD_EMPIRE_MESSAGE, "Please check 479BC-log.txt in your 479BC directory for details."},
