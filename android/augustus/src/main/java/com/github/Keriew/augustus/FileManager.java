package com.github.Keriew.479BC;
...
public class FileManager {
    ...
    static int setBaseUri(Uri newUri) {
        try {
            ...
            Log.e("479BC", "Error in setBaseUri: " + e);
            return 0;
        }
    }
    ...
    private static FileInfo getFileFromPath(479BCMainActivity activity, String filePath) {
        try {
            if (baseUri == Uri.EMPTY) {
                return null;
            }
            ...
            Log.e("479BC", "Error in getFileFromPath: " + e);
            return null;
        }
    }

    @SuppressWarnings("unused")
    public static String[] getDirectoryFileList(479BCMainActivity activity, String dir, int type, String ext) {
    ...
    public static boolean deleteFile(479BCMainActivity activity, String filePath) {
        try {
            ...
            Log.e("479BC", "Error in deleteFile: " + e);
            return false;
        }
    }

    @SuppressWarnings("unused")
    public static int openFileDescriptor(479BCMainActivity activity, String filePath, String mode) {
        try {
            if (baseUri == Uri.EMPTY) {
                return 0;
            }
            ...
            Log.e("479BC", "Error in openFileDescriptor: " + e);
            return 0;
        }
    }
